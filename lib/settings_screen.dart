      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text(isRu ? "Версия 2.8.2 (полная)" : "Version 2.8.2 (full)", style: TextStyle(color: Colors.grey[500], fontSize: 13)),
            Text(isRu ? "Последнее обновление: 28.04.2026" : "Last update: 28.04.2026", style: TextStyle(color: Colors.grey[500], fontSize: 13)),
          ],
        ),
      ),
    );
